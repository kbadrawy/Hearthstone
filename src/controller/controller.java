...
public void actionPerformed(ActionEvent e)  {		
		...
		if (b.getText().contentEquals("Mute Background Music")) {
			mute=true;
...
public void field(Hero hero){
     ...
     if(hero.equals(model.getCurrentHero())){
						...
						// 	a.add(spell);
						 	...
						 	mute.setText("Mute Background Music");
					   	 	mute.setName("Mute Background Music");
					   	    mute.setOpaque(true);
					   	    mute.setBackground(Color.black);
						 	mute.setForeground(Color.MAGENTA);
						 	mute.setFont(new Font("Courier", Font.BOLD,15));
